...
| Requirement                      | Task                           | Key test file(s)                                                                                                                                                                                                                                                                           |
|----------------------------------|--------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SR-006                           | TASK-044a                      | `backend/tests/db/test_repositories.py::test_list_patients_for_doctor_excludes_patients_without_consent`, `backend/tests/clinical/test_clinical_service.py::test_list_accessible_patients_emits_audit_with_basis`, `backend/tests/api/test_clinical_router.py::TestListAccessiblePatients` |
