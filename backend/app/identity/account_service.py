...
class AccountService:
    ...
    def create(self, creator: Account, data: AccountCreate) -> Account:
        ...
        # Enqueue activation email (best-effort; import lazily to avoid circular deps)
        try:
            pass  # noqa: PLC0415
            # Token will be generated by AccountService.issue_activation_token (TASK-032)
            # For now we defer token issuance; the caller will call activate() separately
        except Exception:
            pass
