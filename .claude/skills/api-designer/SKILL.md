...
|-------|-----------|-----------|
| REST Patterns | `assets/rest-patterns.md` | Resource design, HTTP methods, HATEOAS |
| Versioning | `assets/versioning.md` | API versions, deprecation, breaking changes |
| Pagination | `assets/pagination.md` | Cursor, offset, keyset pagination |
| Error Handling | `assets/error-handling.md` | Error responses, RFC 7807, status codes |
| OpenAPI | `assets/openapi.md` | OpenAPI 3.1, documentation, code generation |
